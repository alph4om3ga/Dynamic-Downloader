...
namespace JudasEncodingManager.Converters
{
    ...
    /// <summary>Returns "Searching…" when true, "🔍 Search" when false.</summary>
    public class BoolToSearchLabelConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
            => value is bool b && b ? "Searching…" : "🔍 Search";
